...
3. (Now fixed as of 1.8.0) In the 1.7.0 release the addon seems to not successfully activate the first time, activating it twice will have it start properly. I will try adressing this in the future
